...
function generate_optimized_comprehensive_report(data, basic_stats, efficiency_stats, ...
    ...
    subplot_tight = @(m,n,p,margins) subplot('Position', ...
        [margins(1) + (p-1-floor((p-1)/n)*n)*(1-margins(1)-margins(3))/n, ...
         margins(2) + (floor((p-1)/n))*(1-margins(2)-margins(4))/m, ...
         (1-margins(1)-margins(3))/n - margins(1)/2, ...
         (1-margins(2)-margins(4))/m - margins(2)/2]);
