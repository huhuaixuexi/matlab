...
function data = preprocess_data(data_table)
    ...
    % 基本字段
    data.data_fault_code = data_table.Var1;  % 数据故障代码
    data.fault_time = datetime(data_table.Var2, 'InputFormat', 'yyyy-MM-dd HH:mm:ss');
    data.instrument_fault_code = data_table.Var3;
    data.fault_name = data_table.Var4;
    data.fault_type = data_table.Var5;
    data.severity = data_table.Var6;
    data.priority = data_table.Var7;
    data.operation = data_table.Var8;
    data.duration = data_table.Var9;
    data.tools = data_table.Var10;
